...
def run_task(job: dict) -> str:
    ...
    # Fast deterministic workload used only for benchmarking
    if job.get("type") == "benchmark":
        time.sleep(0.1)
        return "done"

    # Normal demo workload
...
def main():
    ...
    while True:
        ...
        # Tell coordinator that this worker has started executing the task
